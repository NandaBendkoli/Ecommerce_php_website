                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                            ...
                            <td><a href='index.php?edit_category=<?php echo $row["category_id"]; ?>'><i
                                        class='fa-solid fa-pen-to-square text-warning'></i></a></td>
                            <td><a href='index.php?delete_category=<?php echo $row["category_id"]; ?>'><i
